...
def update_menu_icons(env):
    ...
    for item in menu_items:
        ...
        if module_installed:
            ...
            if menu:
                menu.write({
                    "web_icon": f"ashewa_icons,static/src/img/icons/{name}.png",
                    "web_icon_data": f"background: url('/ashewa_icons/static/src/img/icons/{name}.png') no-repeat center; background-size: contain;"
                })
