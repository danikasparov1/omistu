...
//         this.do_action('eg_ai_smart_dashboard_lite.action_custom_dashboard_board');
        ...
        (isConfirm)=>{
            if (isConfirm) {
                    ...
                    .then(function(result){
                        this.rpc('/custom_dashboard/update_chart_item_dashboard', {
...
//            swal({
//                      title: _t("Are you sure you want to remove this item?"),
//                      text: _t("Are you sure you want to remove this item?"),
//                      icon: 'warning',
//                      showCancelButton: true,
//
//                    })
