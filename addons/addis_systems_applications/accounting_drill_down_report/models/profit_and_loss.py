...
class ReportBalanceSheet(models.AbstractModel):
    _name = 'addissystems.report_profitandloss'
...
class ProfitLossExcelReport(models.AbstractModel):
    _name="report.accounting_drill_down_report.report_profit_loss_xlsx"
