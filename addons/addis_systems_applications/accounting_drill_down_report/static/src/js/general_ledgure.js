...
export class GeneralLedgureReportOwl extends BaseDrilldownReport {
    async setup() {
        super.setup()
        this.toggle_lines =this.toggle_lines.bind(this)
        this.report_name = "General Legdure Report"
        ...
        async print_pdf(ev) {
            return this.action.doAction({
                ...
                'report_name': 'accounting_drill_down_report.report_generalledgure',
                'report_file': 'accounting_drill_down_report.report_generalledgure',
                'data': {
        ...
        getxlsx(){
            return this.action.doAction({
                'type': 'ir.actions.report',
                'report_type': 'xlsx',
                'report_name': 'accounting_drill_down_report.report_generalledgure_xlsx',
                'report_file': 'accounting_drill_down_report.report_generalledgure_xlsx',
                'data': {
        ...
        async get_financial_data(){
            this.state.lines = await this.orm.call("addissystems.report_generaledgure", "get_lines", [this.state]); 
...
GeneralLedgureReportOwl.template = "accounting_drill_down_report.general_ledgure_report_owl";
actionRegistry.add("addisystems_general_ledgure", GeneralLedgureReportOwl);