...
export class ChartjsSampleHRGEN extends Component {
    ...
    async fetchData() {
        ...
        const totalCustomers = await this.orm.searchRead("res.partner", [['customer_rank', '>', 0]], ["id"]);
        this.state.totalCustomers = totalCustomers.length;
        console.log('Total Customers:', this.state.totalCustomers);
        const totalVendors = await this.orm.searchRead("res.partner", [['supplier_rank', '>', 0]], ["id"]);
        this.state.totalVendors = totalVendors.length;
        console.log('Total Vendors:', this.state.totalVendors);
    ...
    renderChart() {
        ...
        this.chart = new Chart(this.canvasRef.el, {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: 'Manufacturing planned vs produced',
                        data: contractData,
