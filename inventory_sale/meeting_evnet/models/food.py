...
class EventFoodBookingLine(models.Model):
    """Model that handles the food booking"""
    _name = "event.food.booking.line"
    ...
    uom_id = fields.Many2one('uom.uom', readonly=True,
                             ...
                             default=_get_default_uom_id, help="This will set "
                                                               "the unit of"
                                                               " measure used")
    price_unit = fields.Float(related='food_id.list_price', string='Price',
                              digits='Product Price',
                              help="The price of the selected food item.")
    tax_ids = fields.Many2many('account.tax',
                               'event_hotel_event_food_order_line_taxes_rel',
                               'food_id', 'tax_id',
                               string='Taxes',
